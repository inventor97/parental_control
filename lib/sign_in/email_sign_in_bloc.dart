...
class EmailSignInBloc {
  ...
  Future<void> submit() async {
    ...
    try {
      if (_model.formType == EmailSignInFormType.signIn) {
        ...
        await auth.signUpUserWithEmailAndPassword(_model.email, _model.password, _model.name, _model.surname);
      }
  ...
  void toggleFormType() {
    ...
    ///
    /// [Register] and [SignIn]
    updateWith(email: '', password: '', name: '', surname: '', submitted: false, formType: formType, isLoading: false);
  }
